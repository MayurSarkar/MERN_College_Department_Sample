...
const Home = () => {
  ...
  return (
    <>
      {load && (
        <>
          <Navbar setIsOpen={sethandler} IsOpen={isOpen} />
          <div className="w-[100%] mx-auto mt-8 flex justify-center items-start flex-col container relative">
          <ul
              className={`flex justify-evenly items-center gap-10 w-[90%] mx-auto student__navbar admin__navbar ${
                isOpen ? "student__navbar-open" : "student__navbar-close"
              }`}
            >
                <li
