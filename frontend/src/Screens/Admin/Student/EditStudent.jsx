...
const EditStudent = () => {
  ...
  return (
    <div className="my-6 mx-auto w-full admin__student-edit">
      <form
      ...
      {search && id && (
        <form
          ...
          className="w-[70%] flex justify-center items-center flex-wrap gap-6 mx-auto mt-10 admin__student-edit-form"
        >
          <div className="w-[40%]">
