...
const Subjects = () => {
  ...
  const getSubjectHandler = () => {
    ...
    axios
      .get(`${baseApiURL()}/subject/getSubject`,data, {
        headers: headers,
      })
      .then((response) => {
  ...
  return (
    <div className="w-[85%] mx-auto mt-10 flex justify-center items-start flex-col mb-10">
      <div className="flex justify-between items-center w-full admin__header">
      ...
      {selected === "add" && (
        <div className="flex flex-col justify-center items-center w-full mt-8 admin__form">
