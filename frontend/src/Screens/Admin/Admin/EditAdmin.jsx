  ...
  return (
    <div className="my-6 mx-auto w-full">
      <form
        ...
        className="flex justify-center items-center border-2 border-blue-500 rounded w-[40%] mx-auto admin__form"
      >
        <input
          type="text"
      ...
      {search && id && (
        <form
          ...
          className="w-[70%] flex justify-center items-center flex-wrap gap-6 mx-auto mt-10 admin__form"
        >
          <div className="w-[40%]">
