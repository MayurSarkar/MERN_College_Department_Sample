...
const Login = () => {
  ...
  return (
    <div className="bg-white h-[100vh] w-full flex justify-between items-center login">
      <img
        className="w-[60%] h-[100vh] object-cover"
        src="https://lh3.googleusercontent.com/p/AF1QipPX5WID9lFSDXSnUguo-D_Gk702uGNqCcvbVAIj=s1360-w1360-h1020"
        alt=""
      />
      <div className="w-[40%] flex justify-center items-start flex-col pl-8 login__content">
      ...
      <div className="absolute top-4 right-4 login__nav">
        <button
