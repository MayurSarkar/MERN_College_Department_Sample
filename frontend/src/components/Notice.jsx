...
const Notice = () => {
  ...
  return (
    <div className="w-[85%] mx-auto flex justify-center items-start flex-col my-10">
      <div className="relative flex justify-between items-center w-full notice admin__header-notice">
          ...
          {notice &&
            notice.map((item, index) => {
              return (
                ...
                >
                  <p className="text-sm hidden mb-3 items-center date__mobile">
                  ...
                  <p className="text-sm absolute top-4 right-4 flex justify-center items-center date__desktop">
                    <span className="text-base mr-1">
                      <HiOutlineCalendar />
                    </span>
                    {item.createdAt.split("T")[0].split("-")[2] +
      ...
      {open && (
        <form className="mt-8 w-full admin__form">
